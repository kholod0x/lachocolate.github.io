...
switch($_GET["action"]) {
	case "add":
		if(!empty($_POST["quantity"])) {
			$productByCode = $db_handle->runQuery("SELECT * FROM white WHERE code='" . $_GET["code"] . "'");
...
<div style="direction: none; size: 24px; text-align: center;"> <a href="index.php">BACK TO HOME</a></div>
</BODY></HTML>